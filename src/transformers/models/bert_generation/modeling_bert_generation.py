...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    attn_weights = torch.matmul(query, key.transpose(2, 3)).mul_(scaling)

    if attention_mask is not None:
        # Avoid unnecessary allocation if attention_mask already matches shape
    ...
    # Avoid unnecessary .contiguous() if already contiguous

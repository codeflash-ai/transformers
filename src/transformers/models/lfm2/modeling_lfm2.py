...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    ...
    # Use reshape+expand to avoid creating large intermediate expanded views;
    # It is more memory efficient than inserting a new axis then expanding.
    batch, num_key_value_heads, slen, head_dim = hidden_states.shape
    # Move (batch, num_key_value_heads, seqlen, head_dim) -> (batch, num_key_value_heads * n_rep, seqlen, head_dim) directly
...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    # Optimize matmul by using out= parameter to avoid allocations where possible

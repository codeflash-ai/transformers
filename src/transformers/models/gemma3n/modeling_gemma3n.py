...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    ...
    if n_rep == 1:
        return hidden_states
    # Optimized: Use expand and reshape with improved layout to avoid creating unnecessary views,
    # leverage torch's built-in expand/rearrange logic for better performance.
    # Instead of inserting Nones and explicit advanced indexing, use expand and reshape in a single step.
    # Avoid the intermediate expand of hidden dimension and unnecessary temporary object.
    return (

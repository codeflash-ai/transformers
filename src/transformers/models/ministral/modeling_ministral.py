...
def repeat_kv(hidden_states: torch.Tensor, n_rep: int) -> torch.Tensor:
    ...
    # Faster and more memory-efficient with .reshape and .expand in a single step
    return (
...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    # Avoid unnecessary transpose+matmul by using torch.einsum, which often is faster and more memory-efficient
    # But must preserve output shape and dtype
    ...
    # Use fused softmax+type conversion for efficiency on CUDA (if available) with torch.nn.functional.softmax
    # Only use .to(query.dtype) if needed, avoid extra tensor creation

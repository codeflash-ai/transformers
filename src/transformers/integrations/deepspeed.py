...
def _load_state_dict_into_zero3_model(model_to_load, state_dict):
    ...
    # Use local reference for performance since it's called multiple times
    ...
    def load(module: nn.Module, state_dict, prefix="", assign_to_params_buffers=False):
        ...
        if is_zero3_enabled():
            # Short-circuit if no state_dict key has this prefix.
            # This is faster than creating a list just for computing its length.
            has_prefix = False
            ...
            if has_prefix:
                ...
                # named_parameters returns an iterator; dict constructor is eager but necessary here.
                named_parameters = dict(module.named_parameters(prefix=prefix[:-1], recurse=False))
                # List comprehension replaced with generator for memory efficiency, create list only for params_to_gather which is consumed immediately for the context manager.

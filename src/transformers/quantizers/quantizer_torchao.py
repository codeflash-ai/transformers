...
class TorchAoHfQuantizer(HfQuantizer):
    ...
    def __init__(self, quantization_config, **kwargs):
        ...
        # -- START OPTIMIZATION --
        # Prepare tuple suffixes for faster endswith checks in update_unexpected_keys
        self._full_ao_suffixes = tuple(self.full_ao_keys)
        # -- END OPTIMIZATION --
    ...
    def update_unexpected_keys(self, model, unexpected_keys: list[str]) -> list[str]:
        # Optimized to avoid inner for/any by using str.endswith(tuple_of_suffixes)
        suffixes = self._full_ao_suffixes
